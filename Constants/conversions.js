...
const getCountryName = (countryCode = 'TR') => {
...
const getIsoTo = (countryCode = 'TR') => {
	countryCode = countryCode.toUpperCase();

	if (countryCode in iso2ConvertTo) {
		return iso2ConvertTo[countryCode];
	} else return null;
};

module.exports = { getCountryName, getIsoTo };
